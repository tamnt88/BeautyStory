        ...
        <div class="col-lg-12">
            <div class="card-kpi p-3 bg-white">
                ...
                <ul class="nav nav-tabs" id="productTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="tab-content" data-bs-toggle="tab" data-bs-target="#tab-content-pane" type="button" role="tab">Nội dung</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="tab-images" data-bs-toggle="tab" data-bs-target="#tab-images-pane" type="button" role="tab">Hình ảnh</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="tab-variants" data-bs-toggle="tab" data-bs-target="#tab-variants-pane" type="button" role="tab">Biến thể</button>
                    </li>
                    <li class="nav-item" role="presentation">
                    ...
                    <div class="tab-pane fade show active" id="tab-basic-pane" role="tabpanel">
                        ...
                        <div class="row g-2">
                            <div class="col-md-4">
                                ...
                                <asp:DropDownList ID="CategoryInput" runat="server" CssClass="form-select"></asp:DropDownList>
                            </div>
                            <div class="col-md-4">
